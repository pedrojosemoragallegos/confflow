    ...
    *,
    ...
    for field in schema.fields:
        if isinstance(field, Schema):
            ...
            raise TypeError(f"Unsupported field type: {type(field)}")  # noqa: EM102, TRY003
...
def _format_inline(
    value: list[typing.Any] | dict[typing.Any, typing.Any] | set[typing.Any],
) -> str:
...
def _python_type_to_yaml_type(py_type: type[typing.Any]) -> str:
    type_map: dict[type[typing.Any], str] = {
        str: "string",
        int: "integer",
        float: "float",
        bool: "boolean",
